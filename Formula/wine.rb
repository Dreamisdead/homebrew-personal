...
class Wine < Formula
  ...
  devel do
    url "https://dl.winehq.org/wine/source/3.x/wine-3.5.tar.xz"
    mirror "https://downloads.sourceforge.net/project/wine/Source/wine-3.5.tar.xz"
    sha256 "f42206143b7caf5527dbcd54c21f9b0a22338d8841d7fa08aa6c5f0b9dd72143"

    # Patch to fix screen-flickering issues. Still relevant on 3.5.
    # https://bugs.winehq.org/show_bug.cgi?id=34166
    patch do
      url "https://gist.githubusercontent.com/fxcoudert/539dc389d5f651bf713f684d43bb254b/raw/fd323ddc27df26b5ab7bebe433261a09525aeb0f/wine-mac.patch"
      sha256 "e25e061b6bbb4b95cf3d1baae537b13c5a2508bcf329c48697cf83fe4f51d3b4"
    end
